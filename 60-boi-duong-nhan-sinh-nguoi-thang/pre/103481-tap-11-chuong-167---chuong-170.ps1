...
wget $truyenNameObj.src -o $truyenPngName
wget $tap01Obj.src -o $tapPngName
wget $tapTxtUrl -o $tapTxtName
wget $transparentPngUrl -o $transparentPngName
wget $circleLogoPngUrl -o $circleLogoPngName
pause;