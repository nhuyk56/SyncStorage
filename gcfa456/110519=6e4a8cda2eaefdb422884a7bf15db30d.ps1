$mnv_id = "110519"
$mnvMd5 = "6e4a8cda2eaefdb422884a7bf15db30d"
$truyenName = "Bắt Đầu Hoàng Triều Chi Chủ, Từ Chư Thiên Triệu Hoán Thần Ma"
$TapName = "Tập 15. Chương 343 -> Chương 369"
$tapTxtUrl = "D:\SyncAudioStorage\GroupsTxt\6e4a8cda2eaefdb422884a7bf15db30d.txt"
# $temp = "D:\Temp"
$temp = $env:temp
